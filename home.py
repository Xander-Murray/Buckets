...
from Buckets.components.modules.datemode import DateMode
from Buckets.components.modules.incomemode import IncomeMode
from Buckets.components.modules.insights import Insights
from Buckets.components.modules.records import Records
from Buckets.components.modules.templates import Templates
...
class Home(Static):
    ...
    # -------- Helpers --------
    def rebuild(self, templates: bool = False) -> None:
    ...
    def update_filter_label(self, label: Label) -> None:
        label.update(format_period_to_readable(self.filter))
    ...
    def action_cycle_offset_type(self) -> None:
        ...
        next_type = cycle_order[(current_index + 1) % len(cycle_order)]
